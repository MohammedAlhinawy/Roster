...
-- ============================================================
-- seed default shift types for a new user
-- ============================================================
...
begin
  ...
  values
    (new.id, 'M', 'Morning Shift',   '07:00', '19:00', false, '#E8A33D', 'M', true),
    (new.id, 'N', 'Night Shift',     '19:00', '07:00', true,  '#5B7FE0', 'N', true),
    (new.id, 'O', 'Off Day',          null,    null,   false, '#4C9A6A', 'O', true),
    (new.id, 'L', 'Leave',            null,    null,   false, '#C9A6E8', 'L', true),
    (new.id, 'S', 'Work Assignment', '08:00', '17:00', false, '#4AAFAE', 'S', true)
